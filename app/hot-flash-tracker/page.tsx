...
export const metadata: Metadata = {
  title: "Hot Flash Tracker App for iPhone — Peri Tracker",
  description:
  ...
  alternates: {
    canonical: "https://peritracker.app/hot-flash-tracker",
  },
};
...
export default function HotFlashTrackerPage() {
  return (
    <SeoLandingPage
      ...
      quickAnswer="Peri Tracker logs each hot flash with time of day, severity (mild / moderate / severe), and context. After a few weeks, patterns emerge — which times of day are worst, whether triggers like caffeine or stress are involved, and how frequency changes over your cycle. This data can be exported as a PDF report for your gynecologist."
      audienceBullets={[
      ...
      faqs={[
        {
          ...
          a: "Peri Tracker is designed specifically for perimenopause symptom tracking, including hot flashes. It logs frequency, severity, and time of day; identifies patterns over weeks; and exports a structured PDF report for doctor visits — features not available in general period trackers.",
        },
        {
          q: "How do I track hot flashes on my iPhone?",
          a: "Peri Tracker lets you log a hot flash in under 10 seconds with a severity rating. It automatically tracks frequency over time and shows weekly and monthly trends. No account is required and data stays on your device.",
        },
        {
        ...
        {
          q: "Does Peri Tracker track night sweats separately from hot flashes?",
      ...
      relatedLinks={[
        ...
        { href: "/balance-app-alternative", label: "Balance App Alternative", description: "Compare Peri Tracker to other perimenopause apps" },
      ]}
