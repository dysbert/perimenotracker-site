...
<script type="application/ld+json">{`
{
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, and most doctors welcome it. A structured report showing symptom history, cycle data, and severity trends is far more useful than a verbal summary. Apps like Peri Tracker can export a PDF report specifically designed to be shared with a healthcare provider."
      }
    }
  ]
}
