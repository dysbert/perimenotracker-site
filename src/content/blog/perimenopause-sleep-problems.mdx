...
If Apple Health is active on your device, it captures resting heart rate and (on Apple Watch) sleep stages — data that can add useful context to a subjective sleep log. PerimenoTracker integrates with Apple Health so both streams appear in the same view.
